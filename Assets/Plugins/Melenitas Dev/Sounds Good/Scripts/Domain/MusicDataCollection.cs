...
namespace MelenitasDev.SoundsGood.Domain
{
    public class MusicDataCollection : ScriptableObject
    {
        ...
        public bool CreateMusicTrack (AudioClip[] clips, string tag, CompressionPreset compressionPreset, bool forceToMono, out string result, bool isPitchShiftEnabled)
        {
            ...
            SoundData newSound = new SoundData(tag, clips, compressionPreset, forceToMono, isPitchShiftEnabled);
