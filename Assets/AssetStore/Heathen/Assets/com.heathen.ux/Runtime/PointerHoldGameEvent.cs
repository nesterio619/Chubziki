...
namespace HeathenEngineering.UX
{
    ...
    /// </summary>
    public class PointerHoldGameEvent : MonoBehaviour, IPointerDownHandler, IPointerExitHandler, IPointerUpHandler
    {
        /// <summary>
        ...
        /// </summary>
        public PointerGameEvent evtClickStart;
        /// <summary>
        /// Invoked when the start button is released early or if the pointer leaves the control
        /// </summary>
        public PointerGameEvent evtClickCancel;
        /// <summary>
        /// Invoked when the hold is completed successfuly
        /// </summary>
        public GameEvent evtClickComplete;
        /// <summary>
        /// Invoked each frame while the click is being held and updates the progress as a value between 0 and 1
        /// </summary>
        public FloatGameEvent evtClickProgressed;

        private bool hasMouse = false;
        private float startTime;
        private PointerEventData.InputButton button;

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Correctness", "UNT0008:Null propagation on Unity objects", Justification = "Bad assumption on Unity's part null propigation is a useful feature of programming")]
