...
namespace HeathenEngineering.UX
{
    ...
    /// </summary>
    public class ActionHoldGameEvent : MonoBehaviour
    {
#if ENABLE_INPUT_SYSTEM
        [Serializable]
        public class InputActionCallbackContextGameEvent : GameEvent<InputAction.CallbackContext>
        { }
