...
{
    /// <summary>
    /// A Tooltip Trigger tool which invokes Unity Events as the trigger state changes
    /// </summary>
    [AddComponentMenu("UX/Tooltip/Tooltip Unity Event Trigger")]
    public class TooltipUnityEventTrigger : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [Header("Settings")]
