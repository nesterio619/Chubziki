...
namespace HellTap.MeshKit {
	...
	// Class
	public class BatchMeshSeparator : EditorWindow {
				...
				if( list!=null && list.Count > 0 ){
					...
					foreach( BatchMeshes bm2 in list ){
						if( bm2 != null && bm2.gos[0] != null ){
							...
							bm2.splitMeshes = MeshSeparator.SplitMesh( bm2.gos[0] as GameObject, id ); 
