...
namespace HellTap.MeshKit {
	public class MeshDecimation : UnityEditor.EditorWindow {
		...
		public static void StartDecimation( GameObject go, bool recursive, bool useMeshFilters, bool useSkinnedMeshRenderers,bool enabledRenderersOnly, float quality, bool recalculateNormals, bool preserveBorders = false, bool preserveSeams = false, bool preserveFoldovers = false, bool preserveSurfaceCurvature = false, bool enableSmartLink = true ){
			...
			if( recursive == false ){
				...
				if(
					...
					if( go.GetComponent<SkinnedMeshRenderer>() != null && 
						...
						// Run Process
						DecimateMesh( 
							go.GetComponent<SkinnedMeshRenderer>(), quality, recalculateNormals, preserveBorders, preserveSeams, preserveFoldovers, preserveSurfaceCurvature, enableSmartLink
						);
					...
					// Check for Mesh Filter
						...
						// Run Process
						DecimateMesh( 
							go.GetComponent<MeshFilter>(), quality, recalculateNormals, preserveBorders, preserveSeams, preserveFoldovers, preserveSurfaceCurvature, enableSmartLink
						);
					}
				...
				if(meshfilters.Length > 0){
					foreach( MeshFilter mf in meshfilters ){
						if( mf!=null && mf.sharedMesh != null && 
							...
							DecimateMesh( 
								mf, quality, recalculateNormals, preserveBorders, preserveSeams, preserveFoldovers, preserveSurfaceCurvature, enableSmartLink
							);
				...
				if(skinnedMeshRenderers.Length > 0){
					foreach( SkinnedMeshRenderer smr in skinnedMeshRenderers ){
						if( smr!=null && smr.sharedMesh != null && 
							...
							// Run Process (one mesh per frame)
							DecimateMesh( 
								smr, quality, recalculateNormals, preserveBorders, preserveSeams, preserveFoldovers, preserveSurfaceCurvature, enableSmartLink
							);
