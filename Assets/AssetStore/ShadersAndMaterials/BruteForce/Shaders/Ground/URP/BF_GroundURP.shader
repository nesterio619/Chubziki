...
Shader "BruteForce/URP/GroundURP" {
	...
	Properties{
		...
		[Space(10)]
		_TessellationUniform("Tessellation Tiling", Range(1, 30)) = 1
		_TessellationEdgeLength("Tessellation Ground", Range(0, 100)) = 50
...
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/SurfaceInput.hlsl"
				...
				TessellationFactors MyPatchConstantFunction(
					...
					float redValue = (patch[0].color.g + patch[0].color.b) / 2;
					float blueValue = (patch[0].color.r + patch[0].color.g) / 2;
					...
					f.inside = _TessellationUniform;
#else
					f.inside = lerp(_TessellationUniform, (TessellationEdgeFactor(p1, p2) + TessellationEdgeFactor(p2, p0) + TessellationEdgeFactor(p0, p1)) * (1 / 3.0), redValue);
#endif
				...
				ENDHLSL
					...
					#ifdef USE_COMPLEX_T
											float2 terrainOffsetST4 = (_Splat4_STn.xy);
											float2 terrainOffsetST5 = (_Splat5_STn.xy);
											float2 terrainOffsetST6 = (_Splat6_STn.xy);
											float2 terrainOffsetST7 = (_Splat7_STn.xy);
					#endif
