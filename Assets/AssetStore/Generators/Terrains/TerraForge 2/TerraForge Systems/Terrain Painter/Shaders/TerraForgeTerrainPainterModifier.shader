Shader "Hidden/TerraForgeTerrainPainter/TerraForgeTerrainPainterModifier"
{
    Properties
    {
    	...
    	//TerraForgeTerrainPainterFilters
		...
		_HeightmapScale("TerraForgeTerrainPainterHeight scale", float) = 0
    }

	HLSLINCLUDE

	#include "UnityCG.cginc"
	#include "TerraForgeTerrainPainterFilters.hlsl"
    ...
    SubShader
    {
		...
		Pass
		{
			Name "TerraForgeTerrainPainterHeight"
			HLSLPROGRAM
		...
		Pass
		{		
			Name "TerraForgeTerrainPainterSlope"
			HLSLPROGRAM
			#pragma vertex vert
			#pragma fragment frag
