Shader "Custom/RockGenShader" {
    Properties {
        ...
        _SnowHeight ("Snow Height", Range(0, 10)) = 0.5
        _SnowTransitionWidth ("Snow Transition Width", Range(0, 30)) = 0.1
        ...
        _SandHeight ("Sand Height", Range(0, 10)) = 0.2
