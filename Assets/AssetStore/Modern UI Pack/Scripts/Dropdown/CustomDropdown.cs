...
namespace Michsky.MUIP
{
    public class CustomDropdown : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler, IPointerClickHandler, ISubmitHandler
    {
        ...
        [HideInInspector] public bool isOn;
         public bool isPointerInDropdown;
        ...
        {
            GamepadCursor.SetCurrentScrollRect(_scrollRect, true);
        ...
        {
            GamepadCursor.SetCurrentScrollRect(_scrollRect, false);
